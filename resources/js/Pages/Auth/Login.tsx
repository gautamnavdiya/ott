...
export default function Login() {
  ...
  return (
    <AuthLayout title="Login - Sign In">
      <Head title="Sign In" />
      ...
      <div className="bg-black/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-800 p-8 sm:p-10 animate-slide-up">
          ...
          <div className="flex items-center justify-between pt-2">
            <label className="flex items-center group cursor-pointer">
              <input
                ...
                className="w-4 h-4 rounded border-gray-600 bg-gray-900 text-red-600 focus:ring-2 focus:ring-red-500 focus:ring-offset-0 focus:ring-offset-gray-900 cursor-pointer"
              />
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-black/80 text-gray-500 font-medium">Or continue with</span>
          </div>
        </div>
